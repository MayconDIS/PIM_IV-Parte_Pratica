...
- **[style.css](file:///c:/Users/mayco/Documents/GitHub/PIM_IV-Parte_Pratica/pages/dashboard/style.css)**: Transferência do padrão de fundo quadriculado para o contêiner `.modal-body-mapa` (grade infinita) com opacidade suavizada de 0.02, renomeação de classes/variáveis de terceiros, e mudança da posição do widget de acessibilidade (`.a11y-widget`) para o canto inferior direito da tela (acima do botão voltar ao topo) com abertura reversa.
- **[index.html](file:///c:/Users/mayco/Documents/GitHub/PIM_IV-Parte_Pratica/pages/dashboard/index.html)**: Atualização na importação da folha de estilos com cache-busting (?v=22) e dos scripts, e substituição dos IDs e classes do canvas de `obsidian-` para `neural-`.
